...
##          AND WITH BUCKETED EXTREME CATEGORIES (+-3 score diff, +-2 red card diff, 45+ game minute).
##
##           To save the out-of-sample predictions in .Robj files as follows:
##
## save(file=paste0("LEAVE_SEASON_OUT_PREDICTIONS_NAT_SPLINE_W_BUCKETED_EXTREME_CATEGORIES_TEAM_AND_SEASON_gam_nb_obj", 
##                  "_", league,
##                  #"_", string_add, 
##                  "_Corners.Robj"),
##      pred.list.nb)
