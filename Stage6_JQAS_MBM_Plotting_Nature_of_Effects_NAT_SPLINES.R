#######
##  Stage 6: Code yielding Figure 4 of the Supplement,
...
##           for the case of
##           SIMPLER NATURAL CUBIC SPLINES (no bucketed extreme categories)
#######
...
for (league in league.name){
  ...
  load(paste0("Fitted_Objects/NAT_SPLINE_gam_nb_obj_Team_AND_Season_Mixed_Eff_",
